...
warren_df = fread("20241025_warren_speculative-investment-analysis-dataset.csv", stringsAsFactors = F, encoding = "Latin-1")
...
fwrite(warren_adj_final, "20241025_warren_speculative-investment-analysis-dataset_adjusted.csv")

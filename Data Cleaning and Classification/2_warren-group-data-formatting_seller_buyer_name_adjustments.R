...
warren_df = fread("2000_2025_warren_speculative-investment-analysis-dataset.csv", stringsAsFactors = F, encoding = "Latin-1")
...
fwrite(warren_adj_final, "2000_2025_warren_speculative-investment-analysis-dataset_adjusted.csv")

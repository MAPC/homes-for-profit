...
### load in data ############
setwd(data_path)
warren <- fread("2000_2025_warren_speculative-investment-analysis-dataset_adjusted.csv",
                header=TRUE,
...
fwrite(warren_detailed_final, '2000_2025_warren_speculative-investment-analysis-dataset_adjusted_detailed.csv')

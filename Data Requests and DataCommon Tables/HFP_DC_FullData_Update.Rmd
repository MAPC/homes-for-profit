---
title: "HFP_DC_FullData_Update"
output: html_document
---
This isn't done
- need to pivot this to have separate year columns for 1) full data 2) flip timeline 3)investor timeline
- can you pivot existing 2023 table to do this or do you need to rerun?


# File for aggregation of data to municipality level for table
```{r}
library(tidyverse)
library(sf)

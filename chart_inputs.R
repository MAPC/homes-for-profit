...
#Data - 5yr window
warren <- read_csv("20241220_warren_speculative-investment-analysis-dataset_withforeclosure_5yr-window-networks.csv") %>%
   mutate(investor = ifelse(investor_type_purchase != "Non-investor", "Investor", "Non-investor"),
          total_transactions = n())
warren_noforeclosures <- read_csv("20241220_warren_speculative-investment-analysis-dataset_withoutforeclosure_5yr-window-networks.csv") %>%
   mutate(investor = ifelse(investor_type_purchase != "Non-investor", "Investor", "Non-investor"),
          total_transactions = n())
warren_mapc <- read_csv("20241220_warren_speculative-investment-analysis-dataset_mapc_withforeclosure_5yr-window-networks.csv") %>%
  mutate(investor = ifelse(investor_type_purchase != "Non-investor", "Investor", "Non-investor"),
         total_transactions = n())
warren_mapc_noforeclosures <- read_csv("20241220_warren_speculative-investment-analysis-dataset_mapc_withoutforeclosure_5yr-window-networks.csv") %>%
  mutate(investor = ifelse(investor_type_purchase != "Non-investor", "Investor", "Non-investor"),
         total_transactions = n())
